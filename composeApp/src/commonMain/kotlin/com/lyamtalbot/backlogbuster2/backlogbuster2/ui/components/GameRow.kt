...
private val colourMap: Map<Int, Color> = mapOf(
...
fun GameRow(
    ...
    outerContainerModifier: Modifier = Modifier,
    ...
    return AnimatedVisibility(
        ...
        Row(
            ...
            Row {
                ...
                {
                    Icon(
                        imageVector = if (game.completed) Icons.Filled.Circle else Icons.Outlined.Circle, contentDescription = null,
